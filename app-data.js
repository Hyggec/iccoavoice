(function () {
const voices = [
  { id: 'male-1', label: '男声 1', short: 'Yunxi', edge: 'zh-CN-YunxiNeural', tone: '稳重' },
  { id: 'male-2', label: '男声 2', short: 'Yunyang', edge: 'zh-CN-YunyangNeural', tone: '清晰' },
...
const commands = [
  ...
  { id: 'nav-address', category: 'nav', text: '导航到人民路123号' },
  { id: 'nav-station', category: 'nav', text: '导航到北京火车站' },
  { id: 'call-wife', category: 'call', text: '呼叫老婆' },
  { id: 'call-husband', category: 'call', text: '呼叫老公' },
  ...
  { id: 'other-weather', category: 'other', text: '明天天气怎么样' },
